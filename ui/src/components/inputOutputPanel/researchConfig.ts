...
export const RESEARCH_PRESETS: Record<string, Partial<ResearchConfig>> = {
  performance: {
    alpha_structure: 0.6,
    alpha_texture: 0.25,
    alpha_perceptual: 0.1,
    alpha_diffusion: 0.05,
    low_freq_strength: 1.2,
    mid_freq_strength: 0.8,
    high_freq_strength: 0.6,
    h_sensitivity: 0.5,
    h_blend_reduction: 0.3,
    edge_model_bias: 0.5,
    texture_model_bias: 0.5,
    flat_region_suppression: 0.5,
    preset: "performance",
  },
  balanced: {
    alpha_structure: 0.5,
  ...
  quality: {
    alpha_structure: 0.4,
    alpha_texture: 0.35,
    alpha_perceptual: 0.2,
    alpha_diffusion: 0.05,
    low_freq_strength: 0.8,
    mid_freq_strength: 1.2,
    high_freq_strength: 1.4,
    h_sensitivity: 1.5,
    h_blend_reduction: 0.7,
    edge_model_bias: 0.8,
    texture_model_bias: 0.8,
    flat_region_suppression: 0.2,
    preset: "quality",
  },
};
